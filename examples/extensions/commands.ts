 ...
 * Commands Extension
 *
 * Demonstrates the compatibility `getCommands()` API with a `/commands` command
 * that lists all available slash commands in the current session.
 *
 * Usage:
 * 1. Copy this file to micro's user extensions directory or a project's .micro/extensions/
